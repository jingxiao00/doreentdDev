...
from doreentd.trader.constant import (Direction, Offset, Exchange,
                                  Interval, Status)
from doreentd.trader.database import database_manager
from doreentd.trader.object import TradeData, BarData, TickData, OrderType
from doreentd.trader.utility import round_to
...
class BacktestingEngine:
    ...
    def send_stop_order(
        ...
        self.active_orders[stop_order.vt_orderid] = stop_order
        self.all_orders[stop_order.vt_orderid] = stop_order

        return stop_order.vt_orderid
    ...
    def send_limit_order(
        ...
        self.active_orders[limit_order.vt_orderid] = limit_order
        self.all_orders[limit_order.vt_orderid] = limit_order

        return limit_order.vt_orderid
    ...
    def cancel_all(self, strategy: CtaTemplate):
        ...
        """
        vt_orderids = list(self.active_orders.keys())
