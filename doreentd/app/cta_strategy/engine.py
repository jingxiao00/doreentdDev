...
from doreentd.event import Event, EventEngine
from doreentd.trader.engine import BaseEngine, MainEngine
from doreentd.trader.object import (
    OrderRequest,
    SubscribeRequest,
    HistoryRequest,
    LogData,
...
from doreentd.trader.event import (
    EVENT_TICK,
    EVENT_BAR,
    EVENT_ORDER,
    EVENT_TRADE,
...
from doreentd.trader.constant import (
    Direction,
    OrderType,
    Interval,
    Exchange,
...
from doreentd.trader.utility import load_json, save_json, extract_vt_symbol, round_to
from doreentd.trader.database import database_manager
from doreentd.trader.converter import OffsetConverter
...
class CtaEngine(BaseEngine):
    ...
    def send_order(
        ...
        if stop:
            return self.send_stop_order(strategy, contract, direction, offset, price, volume, lock)
        else:
    ...
    def load_strategy_class(self):
        ...
        self.load_strategy_class_from_folder(
            path1, "doreentd.app.cta_strategy.strategies")
