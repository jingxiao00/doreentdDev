...
from doreentd.trader.constant import Exchange, Interval
from doreentd.trader.object import BarData, TickData
from doreentd.trader.utility import get_file_path
...
def init_sqlite(settings: dict):
    ...
    print("My database path is: ", path)
